...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.trial = 1 # trial counter used for calculating the decay function
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # decay function
            self.epsilon = self.epsilon - 0.01              # default Q-learning
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            # choose action with the highest Q-value
                ...
                for activity in self.Q[state]:
                    if maxQ == self.Q[state][activity]:
                        action_options.append(activity)
...
def run():
    ...
    sim = Simulator(env, display=False, update_delay=0.0000001, log_metrics = True, optimized = True)
